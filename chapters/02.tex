\chapter{Analogical changes in numerals} 
...
In other Kwa\il{Kwa} languages consonants in ‘4’ and ‘5’ differ. To be more precise, in Adjoukrou initial consonants are aligned but they are not nasals: jar ‘4’, jen ‘5’.
...
\midrule
Kordofanian-Talodi\il{Talodi} & Tocho\il{Tocho} & pulu\textbf{k} & we-ra\textbf{k} & wa-ta\textbf{k} &  & \\
Kordofanian-Talodi\il{Talodi} & Jomang\il{Jomang}
% (Talodi)\il{Talodi}
& y-ílli\textbf{k} & y-ilra\textbf{k} & y-ida\textbf{k} & ~ & ~\\
Kordofanian-Talodi\il{Talodi} & Nding\il{Nding} &  & -eta & t-ata\textbf{k} & -ibiɲi\textbf{k} & \\
Kordofanian-Talodi\il{Talodi} & Tegem\il{Tegem} & tléedi & \textbf{pad}er\textbf{ig} & \textbf{pad}a\textbf{ig} &  & \\
Kordofanian-Katla\il{Katla} & Katla\il{Katla} & te:tá\textbf{k} & se\textbf{k} &  &  & \\
Kordofanian-Orig\il{Orig} & Orig\il{Orig} &  &  &  & aru\textbf{m} & wura\textbf{m}\\
Kordofanian-Katla\il{Katla} & Tima\il{Tima} &  & \textbf{eh}ek & \textbf{eh}oat & \textbf{eh}alam & \\
\lspbottomrule
\end{tabular}
}
\end{table}
...
As demonstrated in Appendix 3, mostly contiguous numerals are aligned (see some rare examples above, for example in Nyun\il{Nyun} languages, where features for ‘1’–‘2’/‘4’ are shared, but not for `3'). 
