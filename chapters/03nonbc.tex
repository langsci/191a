...
2 & {\`{ɛ}}-ny{\`{ɔ}}{\`{ɔ}}n & {\={i}}-ɲ{\={i}}{\={ʊ}} & í-ɲ{\'{ɔ}} & ɲ{\'{ɔ}}/nú{\`{ə}} & i-nyɔ & \textbf{i-nyɔ}\\
3 & à-sì & {\={i}}-r{\={i}}{\={u}} & {\`{ɛ}}-tɛ & ti{\'{ɛ}} & i-ta & \textbf{i-ta}\\
4 & {\`{ɛ}}-nàà & {\={i}}-nāŋ & í-na & na & i-na & \textbf{i-na}\\
5 & tòn & {\={i}}-n{\={ʊ}}ŋ & {\`{ɛ}}-lɔ & n{\'{ɔ}} & i-nú & \textbf{i-no(N)}\\
...
20 & {\={e}}brá-ɲ{\textsubtilde{\`{ʊ}}} & òbɾāɲ{\`{\~ʊ}} & àbrúá{\textsubtilde{\'{ɩ}}} & àbr{\'ũ}{\'ã}{\'{\~ɪ}} & lík{\`{ŋ}} & lík{\`{ŋ}} & \textbf{<‘}\textbf{hand’} \textbf{*2?,li-kŋ}\\
...
5 	& nnú 	& {\`{n}}n{\textsubtildeú}& àn{\`{u}} 			& \textbf{n-nu(n)} 					\\
6 	& ncɪ{\`{ɛ}} 	& {\'{ɲ}}c{\'{ɩ}}{\`{ɛ}} 	&àh{\'{ɩ}}{\textsubtilde{\`{ɛ}}}& \textbf{n-c{\'{ɪ}}{\`{ɛ}}}/\textbf{hí{\`{ɛ}}} 	\\
7 	& nc{\`{ʋ}}n 	& {\'{ɲ}}c{\textsubtilde{\^{ʊ}}} 	& àfà 	& \textbf{n-c{\`{ʋ}}n,} \textbf{à-fà}\\
8 	& m{\`{ɔ}}k{\`{ʋ}}{\'{ɛ}} 	& m{\`{ɔ}}kúè 	& àn{\`{ɛ}}mr{\textsubtilde{\`{ɔ}}} 	&  \textbf{m{\`{ɔ}}-k{\`{ʋ}}{\'{ɛ}},} \textbf{à-n{\`{ɛ}}mr{\textsubtilde{\`{ɔ}}}}\\
9 	& puál{\'{ɛ}}h{\`{ʋ}}n 	& p{\`{ʊ}}àl{\textsubtilde{\`{ʊ}}}h{\textsubtilde{\^{ʊ}}} 	& brúkú 	& \textbf{puál{\'{ɛ}}h{\`{ʋ}}n,} \textbf{brúkú}\\
10 	& óblún 	& òb{\`{u}}l{\textsubtildeú} 	& èdí 	& \textbf{ò-b{\`{u}}l{\textsubtildeú},} \textbf{è-dí}\\
...
2 & {\`{ə}}bìé-{\'{n}} & mmie-nú & mie-nu & m{\textsubtilde{ì}}èn{\textsubtildeú}ʔ & \textbf{mie-nú}\\
...
5 & {\`{ə}}-nú{\'{m}} & (e)nú{\'{m}} & num & {\`{n}}n{\textsubtildeú}m & \textbf{nú{\'{m}}}\\
...
2 & {\'{ɲ}}-ɲ{\textsubtilde{\'{ɔ}}} & ɲ{\textsubtildeú}{\textsubtilde{à}} & {\`{ɩ}}-ɲ{\`{ɔ}}\\
...
20 & à-br{\={u}}ā{\textsubtilde{\'{ɛ}}} (10*2?) & dikpilin, koo, bulV & ú-gl{\={u}}\\
100 & y{\v{a}} & 20*5 & 20*5\\
1000 &  & kpen? & \\
\lspbottomrule
\end{tabularx}
...
~~~~~~~~{Potou}  			& wɔ &  &  &  &  & \\
~~~~~~~~\textit{Tano}\\
~~~~~~~~~~~~{Western} 			&  & ò-b{\`{u}}l{\textsubtildeú} &  & è-dí &  & \\
~~~~~~~~~~~~\textit{Central}\\
~~~~~~~~~~~~~~~~{Akanic} 		&  &  & dú &  &  & \\
~~~~~~~~~~~~~~~~{Bia} 			&  & bulu &  &  &  & \\
~~~~~~~~~~~~{Guang}\il{Guang} 		&  &  & du &  &  & \\
...
9 & nòm{\={i}}nā & làmāɗ{\={o}}/wá-zì-ɗú (10-1) \\
10 & wàl & wòl\\
\lspbottomrule
\end{tabularx}
\end{table}
...
\midrule 
1 & do/lo & ɓúd{\={u}}/ɓúr{\={u}} & sèlì & gúlu & sammā, saado & ʈóŋ & ba(k)ra, silla & barak\\
...
5 & lugni & l{\`{u}}ní & à-l{\={o}}n{\={i}} & í-lwār & tɛ(r) & lúɲ & tisso & tisó\\
6 & kaba & táːr & nānò & t{\texthighdropa}ːr & 5+1 & lú-én-ʈóŋ & tipsi & dípsil\\
7 & 5+2 & longa & lúlú & l{\"{\={u}}}r & 5+2 & lú-é-r{\`{ɔ}}k & 5+2 & tiglén\\
...
10 & teba & < Bagirmi,\il{Bagirmi} hul{\=ó}a & k{\`{u}}t{\`{u}} & húlil/lor-poo & filoːle/filori & yíppà & do(k) & dog\\
20 & 10*2 & doksap & 10*2 & <10PL & ʊ-faːlɛ &  & a-rep, a-hun, tehu & \\
100 &  & ro/ru & à-r{\={u}} & a-ru & < Arabic\il{Arabic} & míà/míè &  & ae léd\\
1000 &  & dubu & d{\={u}}bú & dubu & < Arabic\il{Arabic} & hálìf &  & ae har\\
\lspbottomrule
\end{tabularx}
\end{table}
...
\textit{Leko-Duru-Mumuye}\\
~~~~Duru\il{Duru} & 10*2 &  &  & ɡbɛɡ/ ɡbàhs{\'{ɨ}} ('staff'), *w{\'{ɔ}}{\'{ɔ}}ɡ ('head'), zul/ zur (‘head') & ráárò, j{\`{u}}ɡúyɔ\\
...
{1} & kpó-/kpáà-, ɓa-wɨ, ɓ{\={i}}-nì/bì-rì, ú-ma & {7} & 5+2, (mā-nāníkà, l{\`{ɵ}}-rɵzi, zyálá, sáɓá), sílànā/sélènā/ʃí{\={e}}nā (<4?)\\
...
~~~~Ngbaka-\il{Ngbaka}Mba\il{Mba} & ɓ{\={i}}-nì/  bì-rì & kpó-/  kpáà- &  &  & ɓa-wɨ & ú-ma & \\
~~~~Sere\il{Sere} &  &  &  & nj{\~{e}}e &  &  & \\
...
‘One’: Najamba\il{Najamba}-Kindige: \textit{kúndé} ‘1’, Mombo\il{Mombo} \textit{y{\`{ɛ}}ːtáːŋɡ{\`{u}}} ‘1’.
...
{5} & hò-nú & {20} & ɓóní/ɓénle/k{\={e}}w{\={e}}níì\\
...
{6} & k{\={u}}à/kuɔ, d{\={u}}o, h{\`ã}dwàm, kpàr{\`{u}}n & {100} & kòɣ{\={ə}}/kookɛ/k{\'{ɔ}}úkpà/k{\`{ɔ}}{\`{ɔ}}tà\\
&  & {1000} & túsírè\\
\lspbottomrule
\end{tabularx}
\end{table}
...
~ &  & `1' & `2' & `3' & `4' & `5' \\
\midrule
Natioro\il{Natioro} & Dinaoro\il{Dinaoro} & káːbà & ɲ{\'ĩ}nd{\'ĩ} & táe & ŋnáe & s{\`{u}}sú\\
Natioro\il{Natioro} & Timba\il{Timba} & káːbà & ɲ{\'ĩ}ndí & tá & n{\'ã} & s{\`{u}}sú\\
Natioro\il{Natioro} & Kawara\il{Kawara} & kābà & ɲ{\`ĩ}dí & tá & ná & s{\`{u}}sú\\
*Natioro\il{Natioro} &  & káːbà \mbox{(ka-ba?)\footnotemark{}} & ɲ{\'ĩ}ndí & tá(é) & ná (é) & s{\`{u}}sú\\
Wara?\il{Wara} & Sourani\il{Sourani} & p{\'{ɔ}} & b{\v{ɔ}} & t{\'ã} & nàsá & s{\`{u}}sú\\
Wara\il{Wara} & Negeni\il{Negeni} & kàpó & b{\v{o}} & t{\'ĩ}ː & n{\'ã}ːs{\'ũ} & s{\`{u}}sú\\
Wara\il{Wara} & Niansogoni\il{Niansogoni} & p{\'{ʊ}}ːwò & b{\v{o}} & t{\'{ɩ}}ː & náːsó & s{\`{u}}sú\\
*Wara\il{Wara} &  & p{\'{ɔ}} & b{\v{o}}, *n{\={\~{i}}}ntó & t{\'ã}(i) & naaso & s{\`{u}}sú, \\
Palɛn\il{Palɛn} & Faniagara\il{Faniagara} & káfā & bá & t{\'ã}ːré & náːré & s{\`{u}}sú\\
*Palɛn\il{Palɛn} & Faniagara\il{Faniagara} & ká-fā & bá, *n{\'ĩ}nté & t{\'ã}ːré & náːré & s{\`{u}}sú, *si/sɔ\\
\textbf{*Wara-}\il{Wara}\textbf{Natioro-}\il{Natioro}\textbf{Paleni} &  & \textbf{ba/fa,} \textbf{pɔ} & \textbf{n{\'ĩ}nté,} \textbf{b{\v{o}}} & \textbf{ta(r)i} & \textbf{na(r)i} & \textbf{s{\`{u}}sú,} \textbf{sV}\\
~ &  & `6' & `7' & `8' & `9' & `10' \\
...
Wara?\il{Wara} & Sourani\il{Sourani} & s{\`{u}}rp{\'{ɔ}} & s{\={u}}r{\`{u}}dó & s{\`ĩ}nt{\'ã} & s{\`ĩ}nːá & k{\`ã}nːsú\\
...
B. Central:\\~~~~1. Northern\\~~~~~~~~A. Bwamu\il{Bwamu}& pílú/ píru/ ˀɓúrú{\`{u}} &  &  &  & \\
...
It bears reminding that the Bokobaru\il{Bokobaru} root \textit{kuri} ‘ten’ (cf. also Boko\il{Boko} \textit{kúúli} recorded by Koelle) has a direct parallel in the isolated Bangime\il{Bangime} language (\textit{kúr{\'{ɛ}}}).
...
SE-\il{SE}Southern & wúl{\`{u}}/wl{\H{u}}/gbl{\H{ɯ}} (?) & *wágá: wáá & kpi , kɛn\\
\lspbottomrule
\end{tabularx}
\end{table}
...
Noun class markers are usually positioned as suffixes in Kisi\il{Kisi}. However, the first numerical terms in this language have noun class prefixes, which makes the forms look inconsistent, cf. \textit{m{\`{u}}úŋ/} \textit{mì{\'{ɔ}}{\'{ɔ}}ŋ} \textit{/} \textit{ŋì{\'{ɔ}}{\'{ɔ}}ŋ} \textit{/} \textit{dìíŋ,} \textit{tì{\'{ɔ}}{\'{ɔ}}ŋ/là-tì{\'{ɔ}}{\'{ɔ}}ŋ} ’two’.
