...
\node[minimum width=4cm, minimum height=.7cm, inner sep=0pt, draw, fill=white!80!black] (jowulu) {10. Jowulu};
\node[minimum width=4cm, minimum height=.7cm, inner sep=0pt, draw, fill=white!80!black] (samogo) [above=of jowulu,yshift=-1cm] {9. Samogo};
\node[minimum width=4cm, minimum height=.7cm, inner sep=0pt, draw, fill=white!80!black] (bobo) [above=of samogo,yshift=-1cm] {8. Bobo};
\node[minimum width=4cm, minimum height=.7cm, inner sep=0pt, draw, fill=white!80!black] (bozosoninke) [above=of bobo,yshift=-1cm] {7. Bozo-Soninke};
                     
                    
\node[minimum width=2cm, minimum height=.7cm, inner sep=0pt, draw, fill=white!70!black] (swm) [left=of jowulu,xshift=1cm]  {6. SWM};
\node[minimum width=2cm, minimum height=.7cm, inner sep=0pt, draw, fill=white!70!black] (susu) [above=of swm,yshift=-1cm] {5. Susu}; 
                                                                                
\node[minimum width=2.5cm, minimum height=.7cm, inner sep=0pt, draw, fill=white!60!black] (vaikono) [left=of swm,xshift=1cm]  {4. Vai-Kono};
\node[minimum width=2.5cm, minimum height=.7cm, inner sep=0pt, draw, fill=white!60!black] (mokole) [above=of vaikono,yshift=-1cm] {3. Mokole}; 
\node[minimum width=2.5cm, minimum height=.7cm, inner sep=0pt, draw, fill=white!60!black] (jogojeri) [above=of mokole,yshift=-1cm] {2. Jogo-Jeri}; 
\node[minimum width=2.5cm, minimum height=.7cm, inner sep=0pt, draw, fill=white!60!black] (manding) [above=of jogojeri,yshift=-1cm] {1. Manding}; 
