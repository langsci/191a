...
5 & {\={o}}n{\textsubtilde{í}} & {\={o}}ní & {\H{e}}{\H{e}} {\textprimstress}n{\H{e}} & éēnē & y{\^{e}}n & j{\^{e}}n & \textbf{o-ne,l{\`{ɔ}}h{\textsubtilde{\`{ʊ}}},} \textbf{j{\^{e}}n}\\
...
20 & ēbrá-ɲ{\textsubtilde{\`{ʊ}}} & òbɾāɲ{\`{\~ʊ}} & àbrúá{\textsubtilde{\'{ɩ}}} & àbr{\'ũ}{\'ã}{\'{\~ɪ}} & lík{\`{ŋ}} & lík{\`{ŋ}} & \textbf{<‘}\textbf{hand’} \textbf{*2?,li-kŋ}\\
...
\midrule
1 & b{\textsubtilde{\`{ɛ}}}/br{\`{ɛ}} & lóɓ{\={o}} & \textbf{b{\textsubtilde{\`{ɛ}}}} \textbf{/br{\`{ɛ}},} \textbf{ló-ɓ{\={o}};} \textbf{ce/se} & 7 & ákʰwácʰè & óɓīs{\textsubtilde{é}} & \textbf{6+1}\\
2 & m{\textsubtilde{\`{ɔ}}} & {\textsubtilde{ó}}n{\textsubbar{o}}{\textsubtilde{\'{ɔ}}} & \textbf{n{\textsubbar{o}}{\textsubtilde{\'{ɔ}}}} & 8 & áɓyá & ógɓī & \textbf{ɓyá/} \textbf{gɓī}\\
3 & ɓwàɗyá & n{\textsubtilde{\'{ɛ}}}jē/n{\textsubtilde{ó}}jē & \textbf{ɗyá/je} & 9 & áɓr{\`{ɔ}} & ótr{\texthighriseu} & \textbf{ɓr{\`{ɔ}},} \textbf{tr{\texthighriseu}}\\
...
\lsptoprule
\textbf{yéŋ/} \textbf{wà-ɲī}  & Buli\il{Buli} & B. Central & 1. Northern & C. Oti-Volta & i. Buli-\il{Buli}Koma\\
...
Wara?\il{Wara} & Sourani\il{Sourani} & s{\`{u}}rp{\'{ɔ}} & sūr{\`{u}}dó & s{\`ĩ}nt{\'ã} & s{\`ĩ}nːá & k{\`ã}nːsú\\
