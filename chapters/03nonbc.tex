...
At the same time, these patterns cannot be postulated for some of the languages without additional support. The pattern ‘9=10-1’ seems to be apparent in South-Eastern Mande and some of the SWM\il{SWM} languages only, cf. Boko\il{Boko} ‘9’: \textit{k{\`{\~ɛ}}okwi} (litː ‘tear away 1 (from) 10'), \textit{kwi} ‘10’ ; in Busa\il{Busa} ‘9’: \textit{k{\'{\~ɛ}}ndo/k{\'ĩ}{\textsubdot{n}}dokwi} (litː ‘tear away 1 (from) 10'), \textit{kwi} ‘10’, \textit{do} ‘1’; in Bandi\il{Bandi} (SWM) \textit{taá-vu} ‘9’, \textit{ìtá(ŋ)} ‘1’, \textit{p{\'{u}}u} ‘10’. According to Robert Carlson \citep[30]{Carlson1993}, the terms from ‘seven’ to ‘nine’ in Jowulu\il{Jowulu} follow the pattern ‘1-3’ + ‘lose’ (\textit{f{\'{ɔ}}nì}), i.e. \textit{j{\~{\{ɔ}}{\~{\{ɔ}-p{\'{ɔ}}nì} ‘7’, \textit{f{\'{u}}l-p{\'{ɔ}}nì} ‘8’, and \textit{t{\`{\~e}}{\`{\~e}}-p{\'{ɔ}}nì} ‘9’ (note that these terms are misinterpreted as 3+4, 2*4, 5+4\footnote{\href{https://mpi-lingweb.shh.mpg.de/numeral/Jowulu.htm}{https://mpi-lingweb.shh.mpg.de/numeral/Jowulu}\il{Jowulu}\href{https://mpi-lingweb.shh.mpg.de/numeral/Jowulu.htm}{.htm}} by Lee Hochstetler).
