...
\begin{tabularx}{.8\textwidth}{lXll}
\lsptoprule
...
4 & {\`{ɛ}}-nàà & {\={i}}-nāŋ & í-na & na & i-na & \textbf{i-na}\\
...
\midrule
1 & {\`{ŋ}}kp{\={ɔ}} & {\`{ŋ}}kp{\={ɔ}} & {\'{n}} {\textprimstress}n{\'{ɔ}} & {\textsubdot{\'{n}}}n{\`{ɔ}} & ɲâm & ɲâm & \textbf{N-kpɔ,} \textbf{ɲ-âm,} \textbf{*a-ri}\\
2 & āɲ{\textsubtilde{\'{ʊ}}} & āɲ{\'{\~ʊ}} & áá {\textprimstress}n{\'{ʊ}} & áān{\={ʊ}} & yóɲ & ɲóɲ & \textbf{a-ɲ{\textsubbar{ʊ}}}/\textbf{n{\={ʊ}}}\\
3 & ār{\'{ɩ}} & āɾí & {\textsubtilde{\H{ɛ}}}{\textsubtilde{\H{ɛ}}} {\textprimstress}t{\textsubtilde{\H{ɩ}}} & {\'{\~ɛ}}{\={\~{ɛ}}}t{\={ɪ}} & ɲâh{\`{n}} & ɲâh{\`{n}} & \textbf{a-ti(N)/} \textbf{ri}\\
4 & āl{\'{ɛ}} & àl{\'{ɛ}} & {\textsubtilde{\H{a}}}{\textsubtilde{\H{a}}} {\textprimstress}l{\H{a}} & {\'ã}{\={\~{a}}}lā & yâr & jâr & \textbf{a-n{\textsubtilde{í}}}/\textbf{la,} \textbf{jar}\\
...
20 & {\={e}}brá-ɲ{\textsubtilde{\`{ʊ}}} & òbɾāɲ{\`{\~ʊ}} & àbr{\'{u}}á{\textsubtilde{\'{ɩ}}} & àbr{\'ũ}{\'ã}{\'{\~ɪ}} & lík{\`{ŋ}} & lík{\`{ŋ}} & \textbf{<‘}\textbf{hand’} \textbf{*2?,li-kŋ}\\
...
2 & áɲ{\textsubtilde{\'{ɔ}}} & {\textsubtilde{ā}}yr{\`{ɛ}} & \textbf{á-ɲ{\textsubbar{ɔ}},} \textbf{{\textsubtilde{ā}}-yrɛ} & 8 & {\`{ɛ}}ty{\'{ɛ}} & {\={e}}ɥrì & \textbf{{\`{ɛ}}-ty{\'{ɛ}},} \textbf{{\={e}}-ɥrì}\\
...
4 & àn{\textsubtilde{á}} & {\textsubtilde{ā}}z{\`{ɔ}} & \textbf{à-n{\textsubtilde{á}},} \textbf{{\textsubtilde{ā}}-z{\`{ɔ}}} & 10 & èj{\'{u}} & {\={ɛ}}và & \textbf{è-j{\'{u}},} \textbf{{\={ɛ}}-và}\\
...
2 	& aɲ{\`{u}} 	& áɲ{\textsubtilde{û}} 	& àɲ{\textsubtilde{\'{ɔ}}} 	& \textbf{a-ɲu(n)} 					\\
...
20 & à-br{\={u}}ā{\textsubtilde{\'{ɛ}}} (10*2?) & dikpilin, koo, bulV & {\'{u}}-gl{\={u}}\\
100 & y{\v{a}} & 20*5 & 20*5\\
1000 &  & kpen? & \\
\lspbottomrule
\end{tabularx}
...
~~~~~~~~~~~~{Krobu}\il{Krobu} 		& \mbox{à-br{\={u}}ā{\textsubtilde{\'{ɛ}}}} (10*2?) &  &  &  &  & \\
~~~~~~~~~~~~{Ega}\il{Ega} 		&  &  &  &  &  & {\'{u}}-gl{\={u}}\\
\lspbottomrule
\end{tabularx}
\end{table}
...
\midrule
1 & m{\={o}}ndā/mbírāŋ & ɗ{\'{u}}\\
2 & tʃírí & zí\\
3 & h{\textsubtilde{ā}}s{\={i}} (h{\textsubtilde{ā}}-s{\={i}}?) & tā\\
4 & ndày & ndà\\
5 & ndìyārá & n{\={u}}w{\textsubtilde{\={e}}}y\\
6 & mānɡ{\`{u}}l & mènènɡāl\\
7 & ɗ{\={i}}yārā & ɓ{\={e}}álā/ɓ{\={e}}álār\\
8 & ndā-sì (4+3?) & t{\={i}}māl/wá-zì-zí(10-2) \\
9 & nòm{\={i}}nā & làmāɗ{\={o}}/wá-zì-ɗ{\'{u}} (10-1) \\
10 & wàl & wòl\\
\lspbottomrule
\end{tabularx}
\end{table}
...
6 & nón-d{\'{ə}}ə & n{\`{ɔ}}ɔn-ɡb{\'{u}}n{\'{u}} & nɔn\textbf{ɡè} & nɔɔ-waŋɡə & ɡbāā-s{\`{ə}} mâl & bámb{\'{ə}}\textbf{z} & sáámɛ\\
\lspbottomrule
\end{tabularx}
\end{table}
...
\midrule 
1 & do/lo & ɓ{\'{u}}d{\={u}}/ɓ{\'{u}}r{\={u}} & sèlì & g{\'{u}}lu & sammā, saado & ʈóŋ & ba(k)ra, silla & barak\\
2 & i-ru/ li-ru & nd{\={i}}dí/nd{\={i}}rí & à-r{\={i}} & i-li/í-r{\={i}}ː & ɾisːi/lissi & r{\`{ɔ}}k & l{\={e}}ti, retè & l{\={e}}di\\
3 & taro & t{\={e}}rí & à-tā & í-t{\={e}}r & toːɾi & tòòs & teri & t{\={e}}ri\\
4 & nagi/ naro & ni{\dropflata}ːní/néni & à-nā & í-pāw/pa{\~{o}} & naːsɪ & nòr{\textsubtilde{ò}} & har & hār\\
5 & lugni & l{\`{u}}ní & à-l{\={o}}n{\={i}} & í-lwār & tɛ(r) & l{\'{u}}ɲ & tisso & tisó\\
6 & kaba & táːr & nānò & t{\texthighdropa}ːr & 5+1 & l{\'{u}}-én-ʈóŋ & tipsi & dípsil\\
...
9 & 10-X & < Bagirmi\il{Bagirmi} & à-t{\={i}} & lór-lor & 5+4 & sàk{\'{ɔ}}l{\'{ɩ}}nnòr{\textsubtilde{ò}} & diar, 6+3 & jār\\
...
1 & mbew/mbiew, b{\"{ɔ}}{\={ɔ}}ŋ/b{\'{u}}ónó/bóm/vaŋno & 7 & 10-3, rɪŋ, (r{\"{e}}nām, tàrn{\'ã}ɡà)\\
...
2 & d{\={i}}í & 8 & 4 redupl.?\\
3 & tà & 9 & `lacking one'\\
4 & ndà, *b{\={i}}-yām & 10 & m{\textsubtilde{ò}}\\
5 & s{\={ɛ}}rì & 20 & 10*2\\
6 & 5+1 & 100 & t{\`{u}}\\
&  & 1000 & < Bagirmi\il{Bagirmi}\\
\lspbottomrule
...
This branch is comprised of an isolated language. Its attribution to Mbum\il{Mbum}-Day\il{Day} has been a subject of scholarly debate. The form *\textit{mon} `1' is postulated on the basis of \textit{s{\={ɛ}}rì} \textit{mòn} ‘six’, whereas the reconstruction of\textit{*b{\={i}}yām} (\textit{*b{\={i}}-yām}?) `4' is based on \textit{b{\={i}}yām} \textit{tà} ‘seven’.
...
~~~~Kim\il{Kim} & tā &  &  & h{\textsubtilde{ā}}s{\={i}} & \\
~~~~Mbum\il{Mbum} & say &  &  &  & \\
~~~~Day\il{Day} & tà &  &  &  & \\
\textit{Waja-Jen}\\
~~~~Jen & bwa-tə & ɡbunuŋ &  &  & \\
...
~~~~Kim\il{Kim} & n{\={u}}w{\textsubtilde{\={e}}}y &  & ndìyārá & \\
...
~~~~Kim\il{Kim} &  &  &  & ɓ{\={e}}álā/ ɓ{\={e}}álār & ɗ{\={i}}yārā\\
...
~~~~Kim\il{Kim} & ndāsì (4PL?) &  & wázìzí (10–2) & t{\={i}}māl\\
...
{1} & kpó-/kpáà-, ɓa-wɨ, ɓ{\={i}}-nì/bì-rì, {\'{u}}-ma & {7} & 5+2, (mā-nāníkà, l{\`{ɵ}}-rɵzi, zyálá, sáɓá), sílànā/sélènā/ʃí{\={e}}nā (<4?)\\
{2} & b{\={i}}ʃ-ì/ɓ{\={i}}-s{\={i}}, ɓi-né/bí-de, ɡbw{\`{ɔ}} & {8} & s{\'{ɛ}}nā (2*4?), ɡba-dzena/mā-dʒ{\'{ɛ}}nà, (5+3, 10-2)\\
...
{6} & ʃí-tà/si-ta (2*3), mā-ɗíà/ká-zyá, 5+1 & {100} & < Sango,\il{Sango} < Lingala,\il{Lingala} 20*5, (mya, k{\'{ʉ}}l{\'{ɔ}}, kpode, nɡ{\={u}}ndānɡ{\={u}})\\
...
Zande\il{Zande}& bíá-tá/ā-tā &  & lu, b{\={i}}à-nɡì {\textasciitilde} b{\={i}}à-mà \\
\lspbottomrule
\end{tabularx}
\end{table}
...
\textit{Sere-Ngbaka-Mba}\\
~~~~Ngbaka-\il{Ngbaka}Mba\il{Mba} & 5+2 & mā-nāníkà, l{\`{ɵ}}-rɵzi, zyálá, sáɓá, sílànā/sélènā/ʃí{\={e}}nā (<4?)\\
~~~~Sere\il{Sere} & 5+2 & \\
Zande\il{Zande}& 5+2 & \\
\lspbottomrule
\end{tabularx}
...
\textit{Sere-Ngbaka-Mba}\\
~~~~Ngbaka-\il{Ngbaka}Mba\il{Mba} &  & < Sango,\il{Sango} < Lingala,\il{Lingala} 20*5, (mya, k{\'{ʉ}}l{\'{ɔ}}, kpode, nɡ{\={u}}ndānɡ{\={u}})\\
...
\ex \textbf{BU~}(1/1): only \textit{p{\'{u}}-wò} (possibly \textit{p{\'{u}}w-ò}, \textbf{PU?}) in Wara\il{Wara} (J.Wara-Natioro\il{Natioro})
...
\ex \textbf{GU} (1/1) – only \textit{gb{\'{u}}} in Northern Khe\il{Khe} (B. Central: 2. Southern: A. Dogoso\il{Dogoso}-Khe).
\z
\z
...
{1} & yéŋ (adj.), ní (count) & {7} & yòp{\={ɔ}}ā{\={i}}, p{\'{\~o}}{\`ĩ}\\
{2} & y{\`{ɛ}}, li & {8} & nāāniŋ/à-níì (<* 4 redupl., 4PL?)\\
{3} & tà & {9} & nè{\={u}}k/{\`{ŋ}}w{\'{ɛ}}\\
{4} & nààsì/nísà & {10} & p{\={i}}/bâŋ\\
{5} & n{\`{u}} & {20} & 10*2\\
...
{2} & dyā, d{\'{ɛ}}{\'{ɛ}}, diání/dɛɛni, y{\={e}}d{\={e}}/y{\'{ɛ}}ndí & {8} & n{\={e}}{\={i}}/n{\`{\~ɛ}}í/ni/niny{\={\~{ɛ}}}\\
{3} & tâati/tâadi/tāār{\={i}} & {9} & wá{\={i}}/wɛi/w{\={ɛ}}\\
{4} & naa(si) & {10} & pwíɡ{\={ə}}/pííkà/piíkɛ/piitɛ , *pi\\
{5} & num(mu)/nun & {20} & 10*2\\
{6} & k{\={u}}à/kuɔ, d{\={u}}o, h{\`ã}dwàm, kpàr{\`{u}}n & {100} & kòɣ{\={ə}}/kookɛ/k{\'{ɔ}}{\'{u}}kpà/k{\`{ɔ}}{\`{ɔ}}tà\\
&  & {1000} & t{\'{u}}sírè\\
\lspbottomrule
\end{tabularx}
\end{table}
...
{6} & loòb/luu, k{\`{ɔ}}dì/kouul{\'ũ} & {100} & k{\'{u}}b (isol.: pílɛ, k{\`{ɔ}}ta)\\
...
7 & yòp{\={ɔ}}ā{\={i}},  p{\'{\~o}}{\`ĩ} & dood{\={ɛ}} (6+1) & lòlé/ lèlé & yopoi & lèbléʔ & \textbf{*lob-le} \textbf{(6+1)?} \textbf{poi(n)?} \\
...
{4} & na/n{\={i}}ān/nàas & {10} & f{\'{u}}ɡ{\'{ə}}, (fo)\\
...
Natioro\il{Natioro} & Timba\il{Timba} & káːbà & ɲ{\'ĩ}ndí & tá & n{\'ã} & s{\`{u}}s{\'{u}}\\
Natioro\il{Natioro} & Kawara\il{Kawara} & kābà & ɲ{\`ĩ}dí & tá & ná & s{\`{u}}s{\'{u}}\\
*Natioro\il{Natioro} &  & káːbà \mbox{(ka-ba?)\footnotemark{}} & ɲ{\'ĩ}ndí & tá(é) & ná (é) & s{\`{u}}s{\'{u}}\\
Wara?\il{Wara} & Sourani\il{Sourani} & p{\'{ɔ}} & b{\v{ɔ}} & t{\'ã} & nàsá & s{\`{u}}s{\'{u}}\\
Wara\il{Wara} & Negeni\il{Negeni} & kàpó & b{\v{o}} & t{\'ĩ}ː & n{\'ã}ːs{\'ũ} & s{\`{u}}s{\'{u}}\\
Wara\il{Wara} & Niansogoni\il{Niansogoni} & p{\'{ʊ}}ːwò & b{\v{o}} & t{\'{ɩ}}ː & náːsó & s{\`{u}}s{\'{u}}\\
*Wara\il{Wara} &  & p{\'{ɔ}} & b{\v{o}}, *n{\={\~{i}}}ntó & t{\'ã}(i) & naaso & s{\`{u}}s{\'{u}}, \\
Palɛn\il{Palɛn} & Faniagara\il{Faniagara} & káfā & bá & t{\'ã}ːré & náːré & s{\`{u}}s{\'{u}}\\
*Palɛn\il{Palɛn} & Faniagara\il{Faniagara} & ká-fā & bá, *n{\'ĩ}nté & t{\'ã}ːré & náːré & s{\`{u}}s{\'{u}}, *si/sɔ\\
...
Wara?\il{Wara} & Sourani\il{Sourani} & s{\`{u}}rp{\'{ɔ}} & s{\={u}}r{\`{u}}dó & s{\`ĩ}nt{\'ã} & s{\`ĩ}nːá & k{\`ã}nːs{\'{u}}\\
Wara\il{Wara} & Negeni\il{Negeni} & sírípò & s{\'ĩ}n{\={\~{i}}}ntó & s{\={\~{i}}}ntí & s{\={i}}nːáːs{\'ũ} & k{\`ã}ːs{\'ã}\\
Wara\il{Wara} & Niansogoni\il{Niansogoni} & sírìpò & s{\`{u}}r{\`{u}}ntó & s{\={ɩ}}ːnt{\'{ɩ}}ː & s{\'{ɩ}}nː{\'ã}ːs{\'ũ} & k{\`ã}ːs{\'ã}\\
...
\textbf{*Wara-}\il{Wara}\textbf{Natioro-}\il{Natioro}\textbf{Paleni} &  & \textbf{5+1} & \textbf{5+2,} \textbf{téndí?}  & \textbf{5+3,} \textbf{4+4} & \textbf{5+4,} \textbf{kawo?}  & \textbf{p(w)ɔ/} \textbf{fɔ,} \textbf{k{\`ã}ːs{\'ã}?} \\
\lspbottomrule
\end{tabularx}
\end{table}
...
According to other sources, the forms \textit{w{\'ã}/} \textit{nw{\~{o}},} \textit{sɔ} are attested in Wara\il{Wara}-Natioro\il{Natioro} for ‘twenty’. The patterns ‘20*5’ and ‘400*2+200’ are attested for ‘hundred’ and ‘thousand’ respectively.
...
E. Senufo 					 	&  {t{\`ã}{\~{a}}/ taàr} &  {~} &  {~} & tésyàr/ s{\={i}}c{\={ɛ}}r{\={ɛ}}/ tityere\\
...
~~~~~~~~E. Kirma-\il{Kirma}Tyurama\il{Tyurama}  	&  &  & n{\'ũ}{\'{\~ɔ}}s{\`{\~ɔ}} &  & c{\'ĩ}ŋcíel{\`{u}}ó\\
...
\citet{Carlson1993} 	& t{\textsubtilde{è}}{\textsubtilde{è}}nì 	& fu{\textprimstress}u{\textprimstress}l{\={i}} & byā\i᷇, *j{\textsubtilde{\={ɔ}}}{\textsubtilde{\={ɔ}}} 	& pi{\textprimstress}i{\textprimstress}r{\={e}}{\={i}} 	& t{\textsubbar{a}}{\textprimstress}{\textsubbar{a}}{\textprimstress} 	\\
...
\citet{Carlson1993} 	& t{\textsubbar{a}}{\textprimstress}{\textsubbar{a}}{\textprimstress}-mān{\={i}} 	& j{\textsubtilde{\={ɔ}}}{\textsubtilde{\={ɔ}}}-po{\textprimstress}nì 	& fu{\textprimstress}l-po{\textprimstress}nì 	& t{\textsubtilde{è}}{\textsubtilde{è}}-po{\textprimstress}nì 	& by{\textsubtilde{ì}} \\
...
SE-\il{SE}Southern &  & s{\H{a}}ȁ-gā/ sálààkā/ s{\`{ɔ}}làá/ sé-y{\={\textsubtilde{a}}} (5+3?) & \\
\lspbottomrule
\end{tabularx}
\end{table}
...
SE-\il{SE}Southern & *k{\`{ɛ}}m{\'{ɛ}}? & k{\`ẽ}{\={ŋ}}/k{\`ã}{\'{\~ɨ}}, la/l{\'{u}}\\
\lspbottomrule
\end{tabularx}
\end{table}
\todo{check keng/kai}
...
Bozo-\il{Bozo}Soninke\il{Soninke} & gulu & waxa & ('islam')-muso,w{\'{u}}dz{\`ũ}nè\\
Bobo\il{Bobo} &  &  & \\
...
7 & 6+1 & 6+1, 5+2\\
8 & táhtállà/tāntàhlā (4 redupl.), 6+2 & 5+3, 6+2 \citep{Koelle1963}\\
9 & jíntàllá/j{\={i}}ntàhlā (5+4) & 5+4, 6+3 \citep{Koelle1963}\\
