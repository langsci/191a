...
Northern \\
\midrule
Dakoid & Chamba-\il{Chamba}Daka\il{Chamba-Daka} & nàà-sá &   & t{\'{u}}ùná &  \\
*Mambiloid &   & na(n) &   & tien/ tin/ con/ son & ngii?\\
Fam\il{Fam} &  &  & daare & tʃwiine & \\
Tiba\il{Tiba} (Fà) &  & à-nè-á &  & à-t{\={o}}̧ò̧ŋ-á, t{\={u}}ùŋ & \\
...
*Mamfe &   & n(w)i &   & ta(y) &  \\
*Mbam &   & ni(s) &   & taan &  \\
Mbe\il{Mbe} & Mbe\il{Mbe} & ñ{\^{i}} &   & tʃân &  \\
...
It is noteworthy that the terms for `six' and `seven' show similarity not only in case of the root in question, but in case of other roots as well, e.g. J50: Fuliiru\il{Fuliiru} \textit{-lindátù} ‘6’{\textasciitilde} -\textit{linda} ‘7’, Shi\il{Shi} \textit{ńdarhu} ‘6’{\textasciitilde} \textit{ńda} ‘7’.  This similarity is usually conditioned by one of the following factors:
...
\midrule 
1 & k{\`{ɛ}}{\'{ɛ}}-ɲ{\~{ɛ}} & {\~{\`i}}-k{\~{\v{a}}} & {\={e}}-n{\textsubtilde{í}}, {\`{ɔ}}-k{\textsubtilde{\={ɔ}}} & é-ɲ{\'{ɛ}} / {\v{o}}-kâ & \textbf{*ɲ{\'{ɛ}}} , \textbf{ka(n)} & \textbf{*ɲ{\'{ɛ}}} , \textbf{ka(n)}\\
...
Eastern\\
\midrule 
Jera & Iguta\il{Iguta} & tààr{\={u}} & nàːnz{\={i}} &   & ʃùːbì\\
...
Kamuku & Western Acipa\il{Acipa} (Cicipu) & kùtítːí (5+4) &   &   & ùk{\'{u}}pːà &  \\
...
10.& Taroid & Tarok\il{Tarok} (dial.) &  ù-t{\'{u}}k{\'{u}}n &   &  ù-kp{\'{ə}}-ɗ{\'{ɨ}}ŋ (X+1?) &  \\
11.& Western & Yeskwa\il{Yeskwa} (dial.) & èn-ty{\'{u}}ò &   & èn-cí (5+1) &  \\
11.& Western & Rukuba\il{Rukuba} (dial.) &  -t{\'{u}}ŋ &   &  tàiŋ &  \\
11.& Western & Eggon\il{Eggon} (dial.) &  ò-tnó &  *f{\'{u}}{\'{u}}ɲ & ù-fín~(5+1?) & \\
...
4. &Cenral & Izere\il{Izere} & kàt{\'{u}}b{\'{ɔ}}k  (5+X?) &   &   & kù-s{\'{ɔ}}k &  \\
...
6. &Ninzic & Mada\il{Mada} & t{\={i}}y{\={a}}r  (X-1?) &   &   &   & ɡùr\\
6. &Ninzic & Ninzo\il{Ninzo} & t{\={i}}r(s)  (3-X?) &   &   &   & w{\={u}}r\\
7. &Northern & Ikulu\il{Ikulu} &   & t{\'{ɔ}}{\`{ɔ}}ll{\={a}}{\={a}} & nù-k{\={ɔ}}p &   &  \\
