...
1) the most archaic NC families / groups / branches (i.e. those that preserve the inventory of Proto-NC\il{Proto-NC} forms most fully); 

2) NC families / groups / branches that are the most distant from Proto-Niger-Congo\il{Proto-Niger-Congo} in what pertains to the reflection of numerals. 
