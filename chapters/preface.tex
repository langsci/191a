...
Northern Bantoid: & Dakoid & Mambiloid & Fam\index{Fam!} & Tiba\index{Tiba!} (F{\`{a}})\\
\rowcolor{black!20!white}
Southern Bantoid: & \textbf{Bantu} & Beboid & Yemne-Kimbi & Ekoid\\
\rowcolor{black!20!white}
~ & Jarawan & Mamfe & Mbam & Mbe\index{Mbe!}\\
\rowcolor{black!20!white}
~ & Ndemli\index{Ndemli!} & Tikar\index{Tikar!} & Tivoid & Wide Grassfields\\
% \lspbottomrule
\end{tabularx}
\end{table}

The progress of comparative-historical studies of the Bantoid languages has been less impressive than that of Bantu studies. Proto-Bantoid\index{Proto-Bantoid!}, as well as a number of other proto-languages, goes back to the Proto-Eastern-Benue-Congo\index{Proto-Eastern-Benue-Congo!}. In turn, the latter (along with Proto-Western-Benue-Congo\index{Proto-Western-Benue-Congo!} and possibly some other languages that do not belong to these two major groups of Benue-Congo) goes back to Proto-Benue-Congo\index{Proto-Benue-Congo!} (BC). Hence, the Bantoid branch is merely one of 14--15 branches of Benue-Congo, as demonstrated by the chart below (\tabref{tab:0.2}).

 
\begin{table}[b]
\caption{Benue-Congo languages\\
{The inventory of Benue-Congo groups is given mainly by \citealt{Williamson1989b}: 266--269. The main difference in \tabref{ tab:0:2} is that Jukunoid is separated from Platoid, which allows us to better compare the forms of numerals of these groups, as well as the fact that Lufu\index{Lufu!} has been added to isolated languages. The division of the BC into the Western and Eastern branches does not always reflect the genealogical characteristics of languages.}}
\label{tab:0:2}
...
Finally, in addition to Proto-BC there are probably more than ten proto-languages underlying other language families that together comprise the Niger-Congo macro-family (see \tabref{tab:0.3}). 
...
\label{tab:0.3}
\begin{tikzpicture}
\node[minimum width=2.2cm, minimum height=.7cm, inner sep=3pt, draw, fill=black!20!white] (mel)   {Mel\vphantom{j}};
\node[minimum width=2.2cm, minimum height=.7cm, inner sep=3pt, draw, fill=black!20!white] (atlantic) [above=of mel,yshift=-1cm] {Atlantic\vphantom{j}}; 
 
\node[minimum width=2.2cm, minimum height=.7cm, inner sep=3pt, draw, fill=black!60!white] (kru) [right=of mel,xshift=-1cm]  {Kru\vphantom{j}};
\node[minimum width=2.2cm, minimum height=.7cm, inner sep=3pt, draw, fill=white] (mande) [above=of kru,yshift=-1cm] {Mande\vphantom{j}}; 
                                                                                
\node[minimum width=2.2cm, minimum height=.7cm, inner sep=3pt, draw, fill=black!60!white]   (kwa) [right=of kru,xshift=-1cm] {Kwa\vphantom{j}};
...
\node[minimum width=2.2cm, minimum height=.7cm, inner sep=3pt, draw, fill=black!60!white] (ijo) [right=of kwa,xshift=-1cm]  {Ijo};
\node[minimum width=2.2cm, minimum height=.7cm, inner sep=3pt, draw, fill=black!10!white] (ubangi) [above=of ijo,yshift=-1cm] {Ubangi};                                                            

\node[minimum width=2.2cm, minimum height=.7cm, inner sep=3pt, draw, fill=black!60!white] (bc) [right=of ijo,xshift=-1cm] {BC\vphantom{j}};
\node[minimum width=2.2cm, minimum height=.7cm, inner sep=3pt, draw, fill=black!10!white] (adamawa) [above=of bc,yshift=-1cm] {Adamawa\vphantom{j}};
\node[minimum width=2.2cm, minimum height=.7cm, inner sep=3pt, draw, fill=black!40!white] (kordofan) [above=of adamawa,yshift=-1cm] {Kordofan\vphantom{j}};  
...
The following case may serve as an illustration to this statement. Suppose we need to assess one of Greenberg’s proposals, e.g. a Niger-Congo root meaning ‘hill’. Among the reflexes quoted by Greenberg for this root are: “(2) Busa\index{Busa!} \textit{kpi} ‘mountain’, Kweni  \textit{kpi~}; (4) Gã\index{Gã!} \textit{kpɔ~}; Gwa\index{Gwa!} \textit{ogba} ‘mountain’; (5) Nungu\index{Nungu!} \textit{agbɔ}, Ninzam (Ninzo\index{Ninzo!}) \textit{igbu}. Kordofanian: (2) Tagoi\index{Tagoi!} \textit{(c)ibe}.” \citep[155]{Greenberg1966}. The phonetic correspondences underlying the comparison of these forms will not be discussed here (we will just assume that they are valid), for the main problem is elsewhere. A reader with no access to a representative lexical database on the NC languages is always uncertain about a number of key issues, including:
...
\begin{enumerate}
\item there are plenty of forms phonetically similar to those of Greenberg (cf. e.g. Boko\index{Boko!} (in the same sub-group as Busa\index{Busa!}) \textit{kpii} ‘mountain’, Gwari\index{Gwari!} (Nupoid, BC) \textit{{\={o}}p{\'{e}}} ‘hill, mountain’, etc), but the postulated root is at best only marginally attested in the families where Greenberg finds it. 
\item The root is absent in other branches and families (even if the proposed phonetic correspondences are approached most liberally), although, if wished, its “reflexes” can be found in any of the NC families, cf. e.g. Ibani\index{Ibani!} (Ijo) \textit{kp{\'{o}}kp{\'{o}}} ‘hill’, etc. 
...
\begin{enumerate}
\item While comparing the forms of numerical terms attested in the languages under study, their most likely prototypes were established within both of the Atlantic groups, i.e. Northern (Proto-Tenda\index{Proto-Tenda!}, Proto-Jaad-Biafada\index{Proto-Jaad-Biafada!}, Proto-Fula-Sereer\index{Proto-Fula-Sereer!}, Proto-Wolof\index{Proto-Wolof!}, Proto-Cangin\index{Proto-Cangin!}, Proto-Nalu-Baga Fore-Baga Mboteni\index{Proto-Nalu-Baga Fore-Baga Mboteni!}) and Bak (Proto-Joola\index{Proto-Joola!}{}-Bayot\index{Proto-Joola-Bayot!}, Proto-Manjak-Mankanya-Pepel\index{Proto-Manjak-Mankanya-Pepel!}, Proto-Balant\index{Proto-Balant!}, Proto-Bijogo\index{Proto-Bijogo!}).
\item On the basis of these prototypes, the most likely forms of Proto-Northern Atlantic\index{Proto-Northern Atlantic!} and Proto-Bak\index{Proto-Bak!} Atlantic numerals were suggested.
\item On the basis of these more ancient forms, the most plausible reconstruction of Proto-Atlantic\index{Proto-Atlantic!} numerals was offered.
\end{enumerate}

\chapref{sec:4} deals with the reconstruction of the Proto-Niger-Congo\index{Proto-Niger-Congo!} numeral system on the basis of the step-by-step-reconstructions offered in \chapref{sec:3} for each of the twelve major families and a handful of isolates.  
...
1) the most archaic NC families / groups / branches (i.e. those that preserve the inventory of Proto-NC\index{Proto-NC!} forms most fully); 

2) NC families / groups / branches that are the most distant from Proto-Niger-Congo\index{Proto-Niger-Congo!} in what pertains to the reflection of numerals. 
...
In \chapref{sec:3}, along with other NC families, the numerals of the Atlantic languages are analyzed (section 3.12). Atlantic languages are divided into two main groups – North Atlantic (section 3.12.1) and Bak Atlantic (section 3.12.2).

In Sections 3.12.1.1.–3.12.1.7, systems of numerals are considered consecutively in the seven main subgroups of the North Atlantic languages. In particular, in \sectref{sec:3.12.1.3}, numerals in the Jaad\index{Jaad!}{}-Biafada\index{Biafada!} subgroup are considered and it is established that in these languages, for the numeral ‘10', the form \textbf{*}\textit{{}-po} is attested. In the final section of 3.12.1, namely in \sectref{sec:3.12.1.8.} the forms of numerals in the seven northern subgroups are compared, and in particular it is concluded that for Proto-Northern Atlantic\index{Proto-Northern Atlantic!}, the most probable reconstruction for the numeral '10' is the reconstruction of \textit{*pok}.

In Sections 3.12.2.1--3.12.2.4, the numeral systems in each of the four subgroups of the second Atlantic group, namely Bak, are discussed consecutively. The final section concerning the Bak group (3.12.2.5) concludes that the only candidate for reconstructing '10' in the Proto-Bak\index{Proto-Bak!} (in addition to the possible model 10 = 5 * 2) is the root *-\textit{taaj}.

In the final paragraph of section 3.12, namely in 3.12.3, the systems of the North Atlantic languages and the Bak Atlantic languages are compared. This paragraph concludes that the comparative evidence points to the total absence of common roots present in both groups. The only exception to this is the root \textit{*tɔk} \textit{/} \textit{*tVk} ‘five'. Accordingly, it is concluded that it is impossible to reconstruct the Proto-Atlantic\index{Proto-Atlantic!} root for the numeral '10' without the Niger-Congo context.

In \chapref{sec:4}, reconstructions for each family are compared. Accordingly, \chapref{sec:4} has a different structure. If in \chapref{sec:3} each of the sections is devoted to a particular family of languages (in particular, \sectref{sec:3.12} is devoted to the Atlantic languages), then in \chapref{sec:4} each section is devoted to the prospects for the reconstruction of each Niger-Congo numeral. So\index{So!}, in \sectref{sec:4.10.} all intermediate reconstructions for the numeral '10' are considered. It turns out, in particular, that the form \textit{*-taaj} reconstructed for '10' in the Proto-Bak\index{Proto-Bak!} does not find parallels in other Niger-Congo branches. In contrast, the root \textit{*pok} '10', reconstructed for the North Atlantic languages, can be related to the roots reconstructed for the vast majority of Niger-Congo families (it seems to be missing only in Ijo, Dogon and Kordofanian). Based on the NC comparison, the root for '10' is reconstructed as \textit{*pu} \textit{/} \textit{*fu.}

\chapref{sec:5} traces the history of the numerals of Niger-Congo, reconstructed in \chapref{sec:4}, in each individual family of languages. Accordingly, each section, as in \chapref{sec:3}, is devoted to one of the NC families. So\index{So!}, \sectref{sec:5.12.} is devoted to the Atlantic languages. In particular, it is concluded that in the North Atlantic languages the term for '10' has been preserved in three sub-groups (Wolof\index{Wolof!} *\textit{fukk}, Proto-Tenda\index{Proto-Tenda!} *\textit{pəxw}, Proto-Jaad-Biafada\index{Proto-Jaad-Biafada!} *\textit{po}). In the other subgroups it is replaced with isolated innovations. The forms of the Bak languages are also innovated.
