...
I would like to stress that these roots are virtually unattested in Bantu with the meaning ‘five’ or ‘ten’. According to BLR3, the only primary root for ‘five’ commonly attested in Bantu is \textit{*táànò}. At the same time, the root \textit{*dòngò}, which probably goes back to \textit{*dòngò} ‘line, row’ (zones: ABCDEGHJKLMNRS) deserves our attention as well.
