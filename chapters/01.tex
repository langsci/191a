...
In fact, the number of classes in numerals (both singular and plural) can be even bigger. In Soga\il{Soga}, a singular form of `8' \textit{m{\`{u}}-n{\'{ɑ}}ː-n{\`{ɑ}}} (\textsc{cl}3) is always formed from the numeral `4' \textit{{\'{i}}-n{\`{ɑ}}}  (\textsc{cl}5). In Mpumpong\il{Mpumpong} (Bantu, A80), the system of numerals includes four different plural noun classes, that is \textsc{cl}8 for units - \textit{t{\^{ɛ}}n} \textit{n{\`{ɛ}}} \textbf{\textit{ì}}\textit{-n{\^{a}}} ‘9’~ (5+4), \textsc{cl}6 – for dozens – \textbf{\textit{m{\`{ɛ}}}}\textit{-k{\`{a}}m m{\`{ɛ}}-mb{\'{a}}} ‘20’(10*2), \textsc{cl}4  for hundreds – \textbf{\textit{mì}}\textit{-tsȅt mì-mb{\'{a}}}~‘200’ (100*2), and \textsc{cl}2  for thousands – \textbf{\textit{{\`{o}}}}\textit{-t{\'{ɔ}}sìn {\`{o}}-b{\'{a}}} ‘2000’ (1000*2).
