...
Akpes\il{Akpes} & {+} ? & {+} & {+} & {+} & {+} ? & {+} & {-y{\={o}}f(ì), *t-{\={e}}f{\={i}}} &\color{lsLightWine} {6}\\
...
NC \textit{*di} ‘1’: Banda\il{Banda} \textit{bà-l{\={e}}?,} Ngbaka\il{Ngbaka}-Mba\il{Mba} \textit{ɓ{\={i}}-nì/bì-rì}, Zande\il{Zande} \textit{kí-l{\={i}}};
...
SWM\il{SWM} & {*gìláaŋ,} {*tà} & {*fèel}{é} & {s{\={a}}aɓ{\={a}}} & {+} & {d{\'{ɔ}}{\'{ɔ}}lú,} {*wɔ/}{ng{\`{ɔ}}} & {5+3} & {+}\\
...
SE\il{SE} South & {+} & {*pìì-l{\={a}}ŋ} & {*yààká} & {*yìì-s{\`{\textsubtilde{i}}}{\`{\textsubtilde{i}}}y{\'{\textsubtilde{a}}}} & {s{\'{ɔ}}{\'{ɔ}}ɗú} & {5+3}  & {+,} {k}{o,} {s{\'{ɔ}}jɔlú}\\
\lspbottomrule
\end{tabularx}
\end{table}
